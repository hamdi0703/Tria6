    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans overflow-x-hidden selection:bg-indigo-500/30 selection:text-indigo-200">
              ...
              <ScrollReveal>
                  <div className="mb-12">
                    ...
                    <p className="text-base md:text-lg text-neutral-400 leading-relaxed max-w-2xl">
                        Ne izleyeceğine karar veremiyor musun? İzleme Listem'nın entegre mini oyunları ile şansını dene. Her biri farklı bir deneyim sunar.
                    </p>
                  </div>
      ...
      <section className="relative py-24 md:py-32 px-6 text-center overflow-hidden">
          ...
          <ScrollReveal>
            ...
            <p className="mt-8 text-neutral-500 text-xs md:text-sm font-mono tracking-widest">IZLEME LISTEM 2.0 • GÜVENLİ VE HIZLI</p>
          </ScrollReveal>
      </section>
