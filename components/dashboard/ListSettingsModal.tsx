...
import { getCollectionShareUrl } from '../../utils/urlUtils';
...
const ListSettingsModal: React.FC<ListSettingsModalProps> = ({ collection, onClose }) => {
  ...
  const handleTogglePublic = async () => {
      ...
      // State'i hemen güncelle ki UI tepki versin, sonra arkada kaydet
  ...
  const copyLink = () => {
      ...
      const link = getCollectionShareUrl(collection.shareToken);
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-white dark:bg-neutral-950 rounded-3xl shadow-2xl border border-neutral-200 dark:border-neutral-800 animate-slide-in-up overflow-hidden max-h-[90vh] flex flex-col">
        
        {/* Header */}
        <div className="px-6 py-4 border-b border-neutral-100 dark:border-neutral-800 flex items-center justify-between bg-neutral-50 dark:bg-neutral-900/50 flex-shrink-0">
                ...
                <form onSubmit={handleSaveGeneral} className="space-y-6 animate-fade-in">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            className="w-full h-20 px-4 py-3 rounded-xl bg-neutral-100 dark:bg-neutral-900 text-neutral-900 dark:text-white border border-transparent focus:border-indigo-500 outline-none resize-none"
                    ...
                    <button 
                        ...
                        className="w-full py-3 bg-indigo-600 text-white rounded-xl font-bold hover:bg-indigo-700 shadow-lg shadow-indigo-500/20 transition-all transform active:scale-95 disabled:opacity-50"
                    >
                    ...
                    {isPublic ? (
                        <div className="animate-slide-in-up">
                            ...
                            <div className="flex gap-2">
                                <input 
                                    readOnly
                                    value={collection.shareToken ? getCollectionShareUrl(collection.shareToken) : 'Bağlantı oluşturuluyor...'}
