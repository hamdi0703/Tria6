...
const OwnerReviewsSection: React.FC<OwnerReviewsSectionProps> = ({ ownerId, ownerName, movies }) => {
    ...
    if (reviews.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center py-20 text-neutral-500 bg-neutral-50 dark:bg-neutral-900/50 rounded-3xl border border-neutral-200 dark:border-neutral-800 animate-fade-in">
                ...
                <p className="font-medium">{ownerName} bu listedeki yapımlar için henüz bir inceleme yazmamış.</p>
            </div>
        );
    }
