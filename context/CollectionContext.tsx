              ...
              if (data && data.length > 0) {
                  const mapped: Collection[] = data.map((d: any) => {
                      ...
                      if (Array.isArray(d.collection_items) && d.collection_items.length > 0) {
                          itemCount = d.collection_items[0].count || 0;
                      } else if (d.collection_items && typeof d.collection_items[0]?.count === "number") {
                          itemCount = d.collection_items[0].count;
                      } else if (d.collection_items && typeof d.collection_items[0]?.count === "undefined" && d.collection_items[0]) {
                          itemCount = d.collection_items[0].count;
                      }
                      if (d.collection_items && d.collection_items[0] && typeof d.collection_items[0].count !== "undefined") { itemCount = d.collection_items[0].count; } else if (d.collection_items && typeof d.collection_items.count === "number") { itemCount = d.collection_items.count; }
                      return {
                          id: d.id,
                          name: d.name,
